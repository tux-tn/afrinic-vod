                        ...
                        <div class="row">
                            <div class="text center column_6 padding-top">
                                <ul class="social-buttons">
                                    <li><a class="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?url=<?php echo htmlspecialchars("http://$_SERVER[HTTP_HOST]$_SERVER[SCRIPT_NAME]?id=$video[id]"); ?>" target="_blank"><div class="resp-sharing-button resp-sharing-button--facebook resp-sharing-button--small">
                                    ...
                                    <li><a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=<?php echo $video["title"]; ?>&url=<?php echo htmlspecialchars("http://$_SERVER[HTTP_HOST]$_SERVER[SCRIPT_NAME]?id=$video[id]"); ?>" target="_blank"><div class="resp-sharing-button resp-sharing-button--twitter resp-sharing-button--small">
                                                <svg class="resp-sharing-button__icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1em" height="1em" viewBox="0 0 32 32">
                                    ...
                                    <li><a class="resp-sharing-button__link" href="https://plus.google.com/share?url=<?php echo htmlspecialchars("http://$_SERVER[HTTP_HOST]$_SERVER[SCRIPT_NAME]?id=$video[id]"); ?>" target="_blank"><div class="resp-sharing-button resp-sharing-button--google resp-sharing-button--small">
                                                <svg class="resp-sharing-button__icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1em" height="1em" viewBox="0 0 32 32">
